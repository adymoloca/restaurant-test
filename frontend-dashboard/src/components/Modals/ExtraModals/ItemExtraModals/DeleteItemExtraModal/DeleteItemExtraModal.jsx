...
const ExtraItemDeleteModal = (props) => {
  ...
  const Remove = (e) => {
    Axios.delete(data.baseUrl + "api/admin/extras/"+ _id )
      .then((res) => {
        alert("Extra Item was removed successfully !");
        handleClose();
        window.location.reload();
      })
      .catch((err) => {
        alert("Extra Item could not be deleted");
      });
    }
          ...
          <Modal.Title>
            ...
            <BinIcon/>
              <div className="modal-title text-center">
                Are you sure you want to delete the extra item {props.details.extra_name} ?
              </div>
            </div>
          </Modal.Title>
        </Modal.Header>
...
export default ExtraItemDeleteModal;
